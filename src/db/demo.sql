...
-- Volcando datos para la tabla demo.usuarios: ~1 rows (aproximadamente)
DELETE FROM `usuarios`;
INSERT INTO `usuarios` (`id`, `username`, `email`, `password`, `nombre_completo`, `fecha_creacion`) VALUES
	(1, 'admin', 'contacto@syfit.com', 'admin123', 'Administrador Syfit', '2026-02-19 15:27:40');
